...
class Mikedevs_HelpersBundle_KernelDevDebugContainer extends Container
{
    ...
    protected function getUpgradeVersionCommandService()
    {
        ...
        $this->privates['Mikedevs\\HelpersBundle\\Command\\UpgradeVersionCommand'] = $instance = new \Mikedevs\HelpersBundle\Command\UpgradeVersionCommand(new \Mikedevs\HelpersBundle\Manager\UpdaterManager('config/generic-config-file.yaml', 'version'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'mikedevs_helper.yml_path' => 'config/generic-config-file.yaml',
